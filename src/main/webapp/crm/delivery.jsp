...
<%@ page import="java.util.Vector, org.apache.taglibs.standard.functions.Functions"%>
<%
String user_id = request.getParameter("user_id");
String user_type = request.getParameter("user_type");
String csrfToken = (String) session.getAttribute("adminCsrfToken");
    ...
    <div class="delivery-box">
      <div class="delivery-top" style="display: flex; justify-content: space-between; align-items: center;">
        ...
        <div class="action-group">
          ...
          <form id="deliveryDeleteForm_<%=defaultAddr.getAddr_id()%>" method="post" action="deliveryDelete.jsp" style="display:none;">
            <input type="hidden" name="addr_id" value="<%=defaultAddr.getAddr_id()%>">
            ...
            <input type="hidden" name="adminCsrfToken" value="<%=Functions.escapeXml(csrfToken)%>">
          </form>
        </div>
      </div>
    ...
    <div class="delivery-box">
      <div class="delivery-top" style="display: flex; justify-content: space-between; align-items: center;">
        ...
        <div class="action-group">
          ...
          <form id="deliveryDeleteForm_<%=addr.getAddr_id()%>" method="post" action="deliveryDelete.jsp" style="display:none;">
