...
public class DBConnectionMgr {
    ...
    private String _driver = config("EVERYWEAR_DB_DRIVER", "com.mysql.cj.jdbc.Driver"),
            _url = requiredConfig("EVERYWEAR_DB_URL"),
            _user = config("EVERYWEAR_DB_USER", ""),
            _password = config("EVERYWEAR_DB_PASSWORD", "");
